"""Regression checks for the nexus-move-tablebase-scope casebook."""
...
from casebook.harness import assert_expected, nexus_move_tablebase_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(nexus_move_tablebase_scope_summary(), assert_expected())
