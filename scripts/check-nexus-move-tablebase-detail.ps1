...
$repo = "nexus-move-tablebase-scope"
$language = "Elixir"
$category = "Chess and game engines"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/nexus-move-tablebase-walkthrough.md")) {
